...
const Footer = () => {
	return (
		<div class="footer-container">
			...
			<div class="contacts">
				{/* <a
					className="footer-a insta"
					href="https://www.instagram.com/hiphip_jorge__/"
				>
					Instagram
				</a> */}
			...
			<div class="conclusion">
				<a href="https://jorgeperez.me/">
					<img src={logolight} class="logo-light" alt="logo" />
				</a>
				<h3 class="version">portfolio.v.02</h3>
